Rails.application.routes.draw do
  ...
  scope module: 'front' do
    ...
    get 'shops/karaoke/:id', to: 'home#shop_karaoke_detail'
    get 'shops/karaoke/:id/info', to: 'home#shop_karaoke_detail'
    get 'shops/karaoke/:id/system', to: 'home#shop_karaoke_detail_system'
    get 'shops/karaoke/:id/cast', to: 'home#shop_karaoke_detail_cast'
    get 'shops/karaoke/:id/contact', to: 'home#shop_karaoke_detail_contact'
    get 'shops/karaoke/:id/reviews', to: 'home#shop_karaoke_detail_reviews'
    get 'shops/karaoke/:id/write_review', to: 'home#shop_karaoke_detail_write_review'

    get 'shops/bar', to: 'home#shop_bar'
    get 'shops/bar/:id', to: 'home#shop_bar_detail'
    get 'shops/bar/:id/info', to: 'home#shop_bar_detail'
    get 'shops/bar/:id/system', to: 'home#shop_bar_detail_system'
    get 'shops/bar/:id/cast', to: 'home#shop_bar_detail_cast'
    get 'shops/bar/:id/contact', to: 'home#shop_bar_detail_contact'
    get 'shops/bar/:id/reviews', to: 'home#shop_bar_detail_reviews'
    get 'shops/bar/:id/write_review', to: 'home#shop_bar_detail_write_review'

    get 'shops/massage', to: 'home#shop_massage'
    get 'shops/massage/:id', to: 'home#shop_massage_detail'
    get 'shops/massage/:id/info', to: 'home#shop_massage_detail'
    get 'shops/massage/:id/system', to: 'home#shop_massage_detail_system'
    get 'shops/massage/:id/cast', to: 'home#shop_massage_detail_cast'
    get 'shops/massage/:id/contact', to: 'home#shop_massage_detail_contact'
    get 'shops/massage/:id/reviews', to: 'home#shop_massage_detail_reviews'
    get 'shops/massage/:id/write_review', to: 'home#shop_massage_detail_write_review'

    get 'casts/karaoke', to: 'home#cast_karaoke'
    get 'casts/karaoke/:id', to: 'home#cast_karaoke_detail'
    get 'casts/karaoke/:id/info', to: 'home#cast_karaoke_detail'
    get 'casts/karaoke/:id/cast', to: 'home#cast_karaoke_detail_cast'
    get 'casts/karaoke/:id/contact', to: 'home#cast_karaoke_detail_contact'
    get 'casts/karaoke/:id/reviews', to: 'home#cast_karaoke_detail_reviews'

    get 'casts/guide', to: 'home#cast_guide'
    get 'casts/guide/:id', to: 'home#cast_guide_detail'
    get 'casts/guide/:id/info', to: 'home#cast_guide_detail'
    get 'casts/guide/:id/contact', to: 'home#cast_guide_detail_contact'
    get 'casts/guide/:id/reviews', to: 'home#cast_guide_detail_reviews'

    get 'casts/bar', to: 'home#cast_bar'
    get 'casts/bar/:id', to: 'home#cast_bar_detail'
    ...
    get 'casts/massage/:id/info', to: 'home#cast_massage_detail'
    get 'casts/massage/:id/cast', to: 'home#cast_massage_detail_cast'
    get 'casts/massage/:id/contact', to: 'home#cast_massage_detail_contact'
    get 'casts/massage/:id/reviews', to: 'home#cast_massage_detail_reviews'
