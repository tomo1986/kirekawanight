...
.factory 'modalService', ($uibModal,$state) ->
  ...
  sm.error = (message) ->
    modalInstance = $uibModal.open(
      templateUrl: "#{location.protocol + '//' + location.host}/group/tpl/modal/error.html"
  ...
  sm.selectedCell = (count,capsule_count,callback) ->
    modalInstance = $uibModal.open(
      templateUrl: "#{location.protocol + '//' + location.host}/group/tpl/modal/select_cell.html"
      animation: true
      controller: ($scope)->
        self = $scope
  ...
  sm.delete = (message,callback) ->
    modalInstance = $uibModal.open(
      templateUrl: "#{location.protocol + '//' + location.host}/group/tpl/modal/delete.html"
      animation: true
      controller: ($scope)->
        self = $scope
        self.callbackFunc = callback
  ...
  sm.confirm = (title,datas,buttons) ->
    modalInstance = $uibModal.open(
      templateUrl: "#{location.protocol + '//' + location.host}/group/tpl/modal/confirm.html"
      windowClass: 'my-block-bottom'
      keyboard: false
      backdropClick: false
      backdrop: 'static'
  ...
  sm.normalIcons = (callback) ->
    modalInstance = $uibModal.open(
      templateUrl: "#{location.protocol + '//' + location.host}/group/tpl/modal/icon_list.html"
      windowClass: 'my-block-bottom'
      keyboard: false
      backdropClick: false
      backdrop: 'static'
        ...
        self.carouselInitializer = ->
          $(document).ready(() ->
            $('.owl-carousel').owlCarousel(
              ...
              autoPlay: false
              navigationText: [
                '<img src=\'/assets/group/slider/slide-pre.png\'>'
                '<img src=\'/assets/group/slider/slide-next.png\'>'
              ]
            )
          )
  ...
  sm.getAddress = (position, callback) ->
    modalInstance = $uibModal.open(
      templateUrl: "#{location.protocol + '//' + location.host}/group/tpl/modal/map.html"
      windowClass: 'my-block-bottom'
      keyboard: false
      backdropClick: false
      backdrop: 'static'
