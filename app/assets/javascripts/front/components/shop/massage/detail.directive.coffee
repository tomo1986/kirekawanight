...
.directive 'shopMassageDetailDirective', ($state,shopService, modalService,customerService, NgMap, validationService) ->
  ShopMassageDetailController = () ->
    vm = this
    vm.init = ->
      vm.breadcrumb = [{name:'キレカワ',link:'/'},{name:'KARAOKE SHOP',link:'/shops/massage'}]
  ...
  directive =
    restrict: 'A'
    controller: ShopMassageDetailController
    controllerAs: 'vm'
