...
.directive 'shopKaraokeDetailDirective', ($state,shopService, modalService,customerService, NgMap, validationService) ->
  ShopKaraokeDetailController = () ->
    vm = this
    vm.init = ->
      vm.breadcrumb = [{name:'キレカワ',link:'/'},{name:'KARAOKE SHOP',link:'/shops/karaoke'}]
  ...
  directive =
    restrict: 'A'
    controller: ShopKaraokeDetailController
    controllerAs: 'vm'
