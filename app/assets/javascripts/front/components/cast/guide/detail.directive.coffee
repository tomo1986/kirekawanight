...
.directive 'castGuideDetailDirective', ($state,castService, modalService,customerService) ->
  CastGuideDetailController = () ->
    vm = this
    vm.init = ->
      vm.breadcrumb = [{name:'キレカワ',link:'/'},{name:'SEXY CAST',link:'/casts/guide'}]
  ...
  directive =
    restrict: 'A'
    controller: CastGuideDetailController
    controllerAs: 'vm'
